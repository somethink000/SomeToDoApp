...
contextBridge.exposeInMainWorld('tasksDataController', {
  ...
  removeTasksByBox: ( id ) => ipcRenderer.invoke('db-query', "DELETE FROM tasks WHERE id = "+id+""),
  getTask: ( id ) => ipcRenderer.invoke('db-query', "SELECT * FROM tasks WHERE taskBoxId = "+id+""),
